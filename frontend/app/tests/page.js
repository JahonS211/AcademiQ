...
export default function TestsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 py-4">
      {!test ? (
        <div className="card p-10 text-center border-none bg-white dark:bg-slate-900 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-3 max-w-lg mx-auto">
            <input 
              className="input py-4 px-6 rounded-xl bg-slate-50 dark:bg-slate-800/50 border-none focus:ring-2 ring-brandA/20 font-bold text-sm" 
            ...
            <button 
              ...
              disabled={loading}
              className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-black uppercase tracking-widest text-[10px] shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50 whitespace-nowrap"
            >
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-between px-2">
            ...
            <button onClick={() => setTest(null)} className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 transition-colors">✕ {t("logout")}</button>
          </div>
          ...
          {!results ? (
            ...
            >
               ...
               <button 
                ...
                className="mt-10 px-12 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-black uppercase tracking-widest text-[10px]"
               >
                 {t("newTest")}
               </button>
            </motion.div>
